...
execute if score $i_end pfind.var matches 0 if score $f_end pfind.var matches 0 run tag @s add SchedContext
execute if score $i_end pfind.var matches 0 if score $f_end pfind.var matches 0 run schedule function pathfinding:loop_schedule_context 1t