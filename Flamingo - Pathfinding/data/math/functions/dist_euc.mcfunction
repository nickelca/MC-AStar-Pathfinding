...
scoreboard players operation in math = #x pfind.cost_de
scoreboard players operation in math += #y pfind.cost_de
scoreboard players operation in math += #z pfind.cost_de

function math:root
scoreboard players operation @s pfind.cost_de = out math