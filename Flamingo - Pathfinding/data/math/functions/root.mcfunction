...
function math:newton_raphson
function math:newton_raphson
function math:newton_raphson
function math:newton_raphson
execute if score #temp1 math matches 10000.. run function math:newton_raphson
execute if score #temp1 math matches 100000.. run function math:newton_raphson
